 ...
 */
export function getInboundSourceSessionId(db: Database, messageId: string): string | null {
 ...
 */
export function getMostRecentPeerSourceSessionId(db: Database, peerAgentGroupId: string): string | null {
  const row = db
    .prepare(
