...
const mockGetContainerConfig = mock();
mock.module('../db/container-configs.js', () => ({
  getContainerConfig: (...args: unknown[]) => mockGetContainerConfig(...args),
}));

const mockGetAgentGroup = mock();
mock.module('../db/agent-groups.js', () => ({
...
const mockGetResource = mock();
mock.module('./crud.js', () => ({
  getResource: (...args: unknown[]) => mockGetResource(...args),
}));

mock.module('../modules/approvals/index.js', () => ({
  registerApprovalHandler: mock(),
