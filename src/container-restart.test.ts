...
const mockIsContainerRunning = mock<(id: string) => boolean>();
const mockKillContainer = mock<(id: string, reason: string, onExit?: () => void) => void>();
const mockWakeContainer = mock();
...
const mockGetSessionsByAgentGroup = mock();
const mockGetSession = mock();
mock.module('./db/sessions.js', () => ({
  getSessionsByAgentGroup: (...args: unknown[]) => mockGetSessionsByAgentGroup(...args),
  getSession: (...args: unknown[]) => mockGetSession(...args),
}));

const mockWriteSessionMessage = mock();
...
beforeEach(() => {
  ...
  mockGetSessionsByAgentGroup.mockReset();
